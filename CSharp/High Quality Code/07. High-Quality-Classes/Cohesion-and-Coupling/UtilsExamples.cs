namespace CohesionAndCoupling
{
    ...
    public class UtilsExamples
    {
        private static void Main()
        {
            ...
            Cube sampleCube = new Cube() { Width = 3, Height = 4, Depth = 5 };
            Console.WriteLine("Volume = {0:f2}", sampleCube.CalcVolume());
            Console.WriteLine("Diagonal XYZ = {0:f2}", sampleCube.CalcDiagonalXYZ());
            Console.WriteLine("Diagonal XY = {0:f2}", sampleCube.CalcDiagonalXY());
            Console.WriteLine("Diagonal XZ = {0:f2}", sampleCube.CalcDiagonalXZ());
            Console.WriteLine("Diagonal YZ = {0:f2}", sampleCube.CalcDiagonalYZ());
        }
    }
}