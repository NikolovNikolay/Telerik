namespace Methods
{
    ...
    public class Methods
    {
        private static double CalcTriangleArea(double sideA, double sideB, double sideC)
        {
            ...
            double halpPerimeter = (sideA + sideB + sideC) / 2;
            double area = Math.Sqrt(halpPerimeter * (halpPerimeter - sideA) * (halpPerimeter - sideB) * (halpPerimeter - sideC));
            return area;
        }
        ...
        private static string ValueOfNumberToString(int number)
        {
            switch (number)
            {
                ...
                case 8: return "eight";
                case 9: return "nine";
                default: throw new ArgumentException("Number is not recognized");
            }
        }
        ...
        private static void PrintElementAsFormatedNumber(object element, string format)
        {
            if (format == "f")
            {
            ...
            {
                throw new ArgumentException("The input format is not recognized");
            }
        }
        ...
        private static double CalcDistance(Point first, Point second)
        {
            ...
            double poweredY = Math.Pow(second.CoordinateY - first.CoordinateY, 2);
        ...
        private static void Main()
        {
            ...
            PrintElementAsFormatedNumber(1.3, "f");
            PrintElementAsFormatedNumber(0.75, "%");
            PrintElementAsFormatedNumber(2.30, "r");
