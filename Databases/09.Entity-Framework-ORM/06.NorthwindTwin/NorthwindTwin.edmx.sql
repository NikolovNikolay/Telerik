...
-- --------------------------------------------------
-- Date Created: 02/04/2014 14:08:01
-- Generated from EDMX file: E:\GoogleDrive\Telerik Projects\Homeworks\Databases\09.Entity-Framework-ORM\06.NorthwindTwin\NorthwindTwin.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Alphabetical list of products]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Alphabetical list of products];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Category Sales for 1997]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Category Sales for 1997];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Current Product List]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Current Product List];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Customer and Suppliers by City]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Customer and Suppliers by City];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Invoices]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Invoices];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Order Details Extended]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Order Details Extended];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Order Subtotals]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Order Subtotals];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Orders Qry]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Orders Qry];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Product Sales for 1997]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Product Sales for 1997];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Products Above Average Price]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Products Above Average Price];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Products by Category]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Products by Category];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Sales by Category]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Sales by Category];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Sales Totals by Amount]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Sales Totals by Amount];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Summary of Sales by Quarter]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Summary of Sales by Quarter];
GO
IF OBJECT_ID(N'[NorthwindTwinStoreContainer].[Summary of Sales by Year]', 'U') IS NOT NULL
    DROP TABLE [NorthwindTwinStoreContainer].[Summary of Sales by Year];
GO
...
-- Creating non-clustered index for FOREIGN KEY 'FK_CustomerCustomerDemo_Customer'
CREATE INDEX [IX_FK_CustomerCustomerDemo_Customer]
